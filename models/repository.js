    ...
    getAll(params = null) {
        ...
        if (params) {
            Object.keys(params).forEach(function (k) {
                //log(k);
                //log(JSON.stringify(params[k]));
                if (k == "sort") {
                    var list = params[k].split(",");
                    objectsList = utilities.sortObject(objectsList, list[0], list[1]);
                }
                if (k == "Name") {
                    objectsList = utilities.filter(objectsList, k, params[k]);
                }
                if (k == "Category") {
                    objectsList = utilities.filter(objectsList, k, params[k]);
                }
...
Name = *e*
sort = Name,desc
0 = {"Id":1,"Title":"Radio-Canada","Url":"https://ici.radio-canada.ca","Category":"Nouvelles"}
1 = {"Id":3,"Title":"Météo Blainville","Url":"https://www.meteomedia.com/ca/meteo/quebec/blainville","Category":"Météo"}
2 = {"Id":4,"Title":"Windy.com","Url":"https://www.windy.com/station/madis-c3442?45.765,-73.694,8","Category":"Météo"}
3 = {"Id":5,"Title":"NHC","Url":"https://www.nhc.noaa.gov/index.shtml","Category":"Météo"}
4 = {"Id":6,"Title":"CNN","Url":"https://www.cnn.com/","Category":"Nouvelles"}
5 = {"Id":7,"Title":"Facebook","Url":"https://www.facebook.com/","Category":"Réseaux sociaux"}
    */
